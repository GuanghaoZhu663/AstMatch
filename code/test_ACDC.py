...
parser.add_argument('--root_path', type=str, default='../data_split/ACDC', help='data')
parser.add_argument('--exp', type=str, default='AstMatch', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "./model/ACDC_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
